...
##
## Created: Fall 2019
## Author: hw207@duke.edu (for ENV859)
##---------------------------------------------------------------------
...
# !! ".." steps out of the script folder to the data folder
...
# Create the insert cursor, list of objects defined... 
cur = arcpy.da.InsertCursor(outputFC,['Shape@','TagID','LC','Date'])

# iterate through all the text files in data folder
